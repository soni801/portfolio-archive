...
var projects = {
  "school": [{
    ...
    "image": "/assets/images/projects/school/app.jpg",
    ...
    "image": "/assets/images/projects/school/raspberry-pi.jpg",
    ...
    "image": "/assets/images/projects/school/covid-diary.jpg",
    ...
    "image": "/assets/images/projects/school/mindstorms.jpg",
    "subject": "Konseptutvikling og programmering",
    ...
    "image": "/assets/images/projects/school/advertisement.jpg",
...
var _projects = require("/assets/projects.js");
...
var cycleSpeed = 5000;
var maxCycle = [-1000, -300]; // Import projects
...
$("#social-graphide").load("/assets/icons/brands/graphide.svg"); // Load recent projects

var _iterator = _createForOfIteratorHelper(_projects.projects.school),
    _step;

try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    var project = _step.value;
    document.querySelector("#school-projects .cycle").innerHTML += "\n        <div>\n            <img src=\"".concat(project.image, "\" alt=\"Image of ").concat(project.title, "\">\n            <div>\n                <h2>").concat(project.title, "</h2>\n                <p class=\"subject\">").concat(project.subject, "</p>\n                <p>").concat(project.content, "</p>\n                <p class=\"date\">").concat(project.date, "</p>\n            </div>\n        </div>\n    ");
  }
} catch (err) {
  _iterator.e(err);
} finally {
...
var _iterator2 = _createForOfIteratorHelper(_projects.projects.personal),
    _step2;

try {
  for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
    var _project = _step2.value;
    document.querySelector("#personal-projects .cycle").innerHTML += "\n        <div>\n            <img src=\"".concat(_project.image, "\" alt=\"Image of ").concat(_project.title, "\">\n            <div>\n                <h2>").concat(_project.title, "</h2>\n                <p>").concat(_project.content, "</p>\n            </div>\n        </div>\n    ");
...
var projectsOffset = [0, 0];

function cycleProjects() {
  setTimeout(function () {
    {
      var element = document.querySelector("#school-projects .cycle");
      if (projectsOffset[0] > maxCycle[0]) element.style.left = (projectsOffset[0] -= 100) + "vw";else element.style.left = (projectsOffset[0] = 0) + "vw";
    }
    setTimeout(function () {
      var element = document.querySelector("#personal-projects .cycle");
      if (projectsOffset[1] > maxCycle[1]) element.style.left = (projectsOffset[1] -= 100) + "vw";else element.style.left = (projectsOffset[1] = 0) + "vw";
    }, cycleSpeed / 2);
    cycleProjects();
  }, cycleSpeed);
}
