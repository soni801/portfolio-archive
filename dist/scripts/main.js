...
var selectedHeader = 0; // Load header
...
$("#header").load("/sections/header.html", function () {
      ...
      document.querySelectorAll("#header div").forEach(function (e) {
        if (temp === selectedHeader - 1 || temp === 2 && selectedHeader === 0) {
          ...
          setTimeout(function () {
            ...
            var next = temp === 2 ? document.querySelectorAll("#header div")[0] : document.querySelectorAll("#header div")[temp + 1];
  ...
  document.querySelector("#header div").classList.add("visible"); // Set initial highlighting
  ...
  document.querySelector("#header #themes a").classList.add("highlighted"); // Register click listeners
...
$("#social-graphide").load("/assets/icons/brands/graphide.svg"); // Load checkmark in cookie consent
